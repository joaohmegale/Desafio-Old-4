...
function renderSelect() {
    ...
    let option = `<option value="">Todas opções</option>`;
...
function renderTable(data) {
    ...
    data.forEach(el => {
        ...
        html +=`
            <tr>
                <td>${new Date(el.date).toLocaleDateString('pt-br')}</td>
                <td>${el.customer.first_name} ${el.customer.last_name}</td>
                <td>${el.customer.phone}</td>
                <td>${el.store.name}</td>
                <td>${el.store.phone}</td>
                <td>${type}</td>
                <td>${el.amount}</td>
                <td>${el.price.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}</td>
...
function filterSelect() {
    const selectValue = document.getElementById("selectForm").value;
    ...
    const filterSelect = data.filter(el => selectValue === el.type);
